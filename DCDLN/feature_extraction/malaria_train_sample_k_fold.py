...
def main():
    ...
    for fold in range(k_folds):
        ...
        save_path = os.path.abspath(os.path.join(os.getcwd(), './k_fold_result/weights/densenet121'))
        ...
        for epoch in range(num_epochs):
            ...
            results_df.to_excel('F:\\研究\\paper1\\code\\feature_extraction\\k_fold_result\\weights\\densenet121\\results1.xlsx', index=False)
